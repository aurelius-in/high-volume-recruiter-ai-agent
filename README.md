...
##### Notice: the same screen after triggering outreach and automation; tiles and the funnel animate as new events arrive.
...
##### Notice: the filtered job and candidate results appear side‑by‑side for quick matching.
...
##### Notice: the replayable audit and policy context make it easy to inspect decisions and outcomes.
...
##### Notice: the journey view reflects the candidate you selected and keeps a clean, consistent layout.
...
##### Notice: Outreach, Scheduling, Candidate Journey, and Audit & Ask all render in Arabic.
...
##### Notice: the same flows as English/Arabic, fully localized for Chinese.
